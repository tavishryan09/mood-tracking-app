  ...
  return (
    <td
      ...
      style={{
        ...
        padding: 0,
        margin: 0,
        borderTop: `1px solid ${weekdayCellBg}`,
        borderLeft: `1px solid ${weekdayCellBg}`,
        borderRight: `1px solid ${weekdayCellBg}`,
        borderBottom: isLastBlockForUser || isLastUser ? `5px solid ${teamMemberBorderColor}` : `1px solid ${weekdayCellBg}`,
