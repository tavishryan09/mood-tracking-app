  ...
  return (
    <td
      ...
      style={{
        ...
        padding: 0,
        margin: 0,
        borderTop: `0.5px solid ${cellBorderColor}`,
        borderLeft: `0.5px solid ${cellBorderColor}`,
        borderRight: `0.5px solid ${cellBorderColor}`,
        borderBottom: (isLastBlockForUser && !isLastUser) ? `5px solid ${teamMemberBorderColor}` : `0.5px solid ${cellBorderColor}`,
